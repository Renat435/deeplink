document.addEventListener('DOMContentLoaded', () => {
    document.querySelector('.link').addEventListener('click', () => {
        if (navigator.userAgent.includes("iPhone")) {
            alert('pizdec')
            window.location.href = "sberbankonline://payments/p2p-by-phone-number?phoneNumber=+79652259554";
            setTimeout(() => window.location.href = "sbolonline://payments/p2p-by-phone-number?phoneNumber=+79652259554", 100);
